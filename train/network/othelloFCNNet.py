...
class OthelloFCNNet(nn.Module):
    def __init__(self, game, args):
        ...
        self.valueFc = nn.Linear(args.num_channels, 1)
        self.piFc = nn.Linear(int(args.num_channels / 4), 1)
    ...
    def forward(self, s):
        ...
        piNull = self.piFc(piNull) # batch_size x 1
